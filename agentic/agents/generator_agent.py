...
1. **Content Synthesis**: Combine code diffs, repository context, and Jira ticket information into coherent release notes
2. **Technical Translation**: Convert technical changes into user-friendly descriptions
3. **Categorization**: Organize changes into logical categories (New Features, Bug Fixes, Improvements, etc.)
...
- Create clear, concise summaries of new features and bug fixes
